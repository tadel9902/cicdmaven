    ...
    <footer class="flex_center" style="background-color: var(--blue);">
        <div class="_1200px flex" style="padding: 30px 0px;">
            <div class="footer_left" style="flex: 3; color: #fff;">
                ...
                <p>Bookstore là một công ty TNHH 3 thành viên rất uy tín chuyên mua bán sách được thành lập năm 2023 phục vụ nhu cầu báo cáo đồ án giá cực rẻ chỉ tương đương với một chiếc bánh mỳ.</p>
            </div>
            <div class="footer_mid" style="flex: 4; color: #fff; text-align: center;">
                <h3 class="pd-10_0">Hotline Chăm Sóc Khách Hàng</h3>
                <div>
                    <p><a href="tel:0905100374" style="text-decoration: none;color: #f19f01;font-weight: 700;">0905100374 (Le Dinh My)</a></p>

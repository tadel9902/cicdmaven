                ...
                <div style="padding: 20px; display:flex">
                    <div class="col-6">
                        <div style="margin-bottom: 20px">
                            ...
                            <input class="form-control showordisable"  id="user-name" name="username" type="text" placeholder="VD: leDinhMy"/>
                        </div>
                        ...
                        <div style="margin-bottom: 20px">
                            ...
                            <input class="form-control showordisable" id="user-email" name="email" type="email" placeholder="VD: nguyenvana@gmail.com"/>
                        </div>
                    ...
                    <div class="col-6">
                        ...
                        <div style="margin-bottom: 20px">
                            ...
                            <input class="form-control showordisable" id="user-phone" name="phone" type="number" placeholder="VD: 0378544081"/>
                        </div>
